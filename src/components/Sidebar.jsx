...
<ul className="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <a className="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
    ...
    <div className="sidebar-brand-text mx-3">Fruitkha Admin <sup>2</sup></div>
  </a>
  {/* Divider */}
  ...
  <div className="sidebar-heading">
   ...
   <li className="nav-item">
    <a className="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseProduct" aria-expanded="true" aria-controls="collapseTwo">
      <i className="fas fa-solid fa-tag" />
      <span>Products</span> 
    </a>
    <div id="collapseProduct" className="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
      <div className="bg-white py-2 collapse-inner rounded">
        ...
        <Link className="collapse-item" to="addProduct">New Product</Link>
        <Link className="collapse-item" to="viewProduct">All Products</Link>
      </div>
    </div>
  </li>
  {/* Products start */}
  ...
  <li className="nav-item">
    ...
    <div id="collapseTwo" className="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
      <div className="bg-white py-2 collapse-inner rounded">
        <h6 className="collapse-header">Custom Orders:</h6>
        <a className="collapse-item" href="buttons.html">Pending Orders</a>
        <a className="collapse-item" href="cards.html">Proceessing Orders</a>
      </div>
    </div>
  </li>
